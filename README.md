...
**Gala** is developed by researchers at the **Flatiron Institute**, led by [Adrian Price-Whelan](http://adrian.pw/). It provides the core efficient tools for performing common tasks needed in Galactic Dynamics, such as gravitational potential evaluations and orbit integrations. Gala Studio relies on this robust foundation for all its scientific computations.
